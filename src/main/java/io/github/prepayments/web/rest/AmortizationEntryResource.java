...
public class AmortizationEntryResource {
    ...
    private static final String ENTITY_NAME = "amortizationEntry";
    ...
    public ResponseEntity<AmortizationEntryDTO> createAmortizationEntry(@RequestBody AmortizationEntryDTO amortizationEntryDTO) throws URISyntaxException {
    ...
    public ResponseEntity<AmortizationEntryDTO> updateAmortizationEntry(@RequestBody AmortizationEntryDTO amortizationEntryDTO) throws URISyntaxException {

...
public class PrepaymentEntryResource {
    ...
    private static final String ENTITY_NAME = "prepaymentEntry";
    ...
    public ResponseEntity<PrepaymentEntryDTO> createPrepaymentEntry(@RequestBody PrepaymentEntryDTO prepaymentEntryDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PrepaymentEntryDTO> updatePrepaymentEntry(@RequestBody PrepaymentEntryDTO prepaymentEntryDTO) throws URISyntaxException {

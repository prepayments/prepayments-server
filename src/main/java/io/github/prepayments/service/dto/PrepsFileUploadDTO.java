...
/**
 * A DTO for the {@link io.github.prepayments.domain.PrepsFileUpload} entity.
 */
public class PrepsFileUploadDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrepsFileUploadDTO)) {
            return false;
        }

        return id != null && id.equals(((PrepsFileUploadDTO) o).id);
    }

...
/**
 * Criteria class for the {@link io.github.prepayments.domain.PrepsMessageToken} entity. This class is used
 * in {@link io.github.prepayments.web.rest.PrepsMessageTokenResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /preps-message-tokens?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PrepsMessageTokenCriteria implements Serializable, Criteria {
    ...
    public PrepsMessageTokenCriteria() {
    }

    public PrepsMessageTokenCriteria(PrepsMessageTokenCriteria other) {
    ...
    @Override
    public PrepsMessageTokenCriteria copy() {
        return new PrepsMessageTokenCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final PrepsMessageTokenCriteria that = (PrepsMessageTokenCriteria) o;
        return
    ...
    public String toString() {
        return "PrepsMessageTokenCriteria{" +
                (id != null ? "id=" + id + ", " : "") +

...
/**
 * A DTO for the {@link io.github.prepayments.domain.PrepsMessageToken} entity.
 */
public class PrepsMessageTokenDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrepsMessageTokenDTO)) {
            return false;
        }

        return id != null && id.equals(((PrepsMessageTokenDTO) o).id);
    }

 ...
 */
public class BatchSupportedFileUploadProcessor implements FileUploadProcessor<PrepsFileUploadDTO>  {
    ...
    private final PrepsFileModelType fileModelType;

    public BatchSupportedFileUploadProcessor(final JobLauncher jobLauncher, final Job batchJob, final PrepsFileModelType fileModelType) {
    ...
    @Override
    public PrepsFileUploadDTO processFileUpload(final PrepsFileUploadDTO fileUpload, final FileNotification fileNotification) {

        if (fileNotification.getprepsfileModelType() == fileModelType) {

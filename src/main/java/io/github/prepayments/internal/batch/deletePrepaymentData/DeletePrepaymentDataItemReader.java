...
@Slf4j
@Scope("job")
public class DeletePrepaymentDataItemReader implements ItemReader<List<PrepaymentDataDTO>> {

    private String messageToken;
    private PrepaymentDataCriteria deleteFileCriteria;
    ...
    DeletePrepaymentDataItemReader(@Value("#{jobParameters['messageToken']}") String messageToken, final PrepaymentDataQueryService prepaymentDataQueryService,
    ...
    private void initializeResources() {
        ...
        deleteFileCriteria = new PrepaymentDataCriteria();
        ...
        final List<PrepaymentDataDTO> unProcessedItems = prepaymentDataQueryService.findByCriteria(deleteFileCriteria);

        prepaymentsDataDTOPartition = new ListPartition<>(fileUploadsProperties.getLargeUploads(), unProcessedItems);

        log.info("Prepayments-Data items for deletion : {}", unProcessedItems.size());
    }

...
public class FileNotification implements TokenizableMessage<String> {
    ...
    private PrepsFileModelType prepsfileModelType;

    public FileNotification(String fileId, long timestamp, String filename, String messageToken, String description, PrepsFileModelType prepsfileModelType) {
            this.fileId = fileId;
            this.timestamp = timestamp;
            this.filename = filename;
            this.messageToken = messageToken;
            this.description = description;
            this.prepsfileModelType = prepsfileModelType;
        }
        ...
        public PrepsFileModelType getprepsfileModelType() {
            return this.prepsfileModelType;
        }
        ...
        public void setprepsfileModelType(PrepsFileModelType prepsfileModelType) {
            this.prepsfileModelType = prepsfileModelType;
        }
        ...
        public boolean equals(final Object o) {
            ...
            if (this$description == null ? other$description != null : !this$description.equals(other$description))
                return false;
            final Object this$prepsfileModelType = this.getprepsfileModelType();
            final Object other$prepsfileModelType = other.getprepsfileModelType();
            if (this$prepsfileModelType == null ? other$prepsfileModelType != null : !this$prepsfileModelType.equals(other$prepsfileModelType))
                return false;
            return true;
        }
        ...
        public int hashCode() {
            ...
            final Object $prepsfileModelType = this.getprepsfileModelType();
            result = result * PRIME + ($prepsfileModelType == null ? 43 : $prepsfileModelType.hashCode());
            return result;
        }

        public String toString() {
            return "FileNotification(fileId=" + this.getFileId() + ", timestamp=" + this.getTimestamp() + ", filename=" + this.getFilename() + ", messageToken=" + this.getMessageToken() + ", description=" + this.getDescription() + ", prepsfileModelType=" + this.getprepsfileModelType() + ")";
        }
        ...
        public static class FileNotificationBuilder {
            ...
            public FileNotification.FileNotificationBuilder prepsfileModelType(PrepsFileModelType prepsfileModelType) {
                this.prepsfileModelType = prepsfileModelType;
                return this;
            }

            public FileNotification build() {
                return new FileNotification(fileId, timestamp, filename, messageToken, description, prepsfileModelType);
            }

            public String toString() {
                return "FileNotification.FileNotificationBuilder(fileId=" + this.fileId + ", timestamp=" + this.timestamp + ", filename=" + this.filename + ", messageToken=" + this.messageToken + ", description=" + this.description + ", prepsfileModelType=" + this.prepsfileModelType + ")";
            }
        }
}

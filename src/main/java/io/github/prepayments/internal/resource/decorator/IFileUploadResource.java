...
public interface IFileUploadResource {
     ...
     */
    ResponseEntity<PrepsFileUploadDTO> createFileUpload(@Valid @RequestBody PrepsFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ResponseEntity<PrepsFileUploadDTO> updateFileUpload(@Valid @RequestBody PrepsFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     */
    ResponseEntity<List<PrepsFileUploadDTO>> getAllFileUploads(PrepsFileUploadCriteria criteria, Pageable pageable);
     ...
     */
    ResponseEntity<Long> countFileUploads(PrepsFileUploadCriteria criteria);
     ...
     */
    ResponseEntity<PrepsFileUploadDTO> getFileUpload(@PathVariable Long id);

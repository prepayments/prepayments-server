...
import io.github.prepayments.web.rest.PrepsFileUploadResource;
...
public class FileUploadResourceDecorator implements IFileUploadResource {
    ...
    private final PrepsFileUploadResource fileUploadResource;

    public FileUploadResourceDecorator(final PrepsFileUploadResource fileUploadResource) {
    ...
    public ResponseEntity<PrepsFileUploadDTO> createFileUpload(@Valid @RequestBody PrepsFileUploadDTO fileUploadDTO) throws URISyntaxException {
        ...
        return fileUploadResource.createPrepsFileUpload(fileUploadDTO);
    }
    ...
    public ResponseEntity<PrepsFileUploadDTO> updateFileUpload(@Valid @RequestBody PrepsFileUploadDTO fileUploadDTO) throws URISyntaxException {
        ...
        return fileUploadResource.updatePrepsFileUpload(fileUploadDTO);
    }
    ...
    public ResponseEntity<List<PrepsFileUploadDTO>> getAllFileUploads(PrepsFileUploadCriteria criteria, Pageable pageable) {
        ...
        return fileUploadResource.getAllPrepsFileUploads(criteria, pageable);
    }
    ...
    public ResponseEntity<Long> countFileUploads(PrepsFileUploadCriteria criteria) {
        ...
        return fileUploadResource.countPrepsFileUploads(criteria);
    }
    ...
    public ResponseEntity<PrepsFileUploadDTO> getFileUpload(@PathVariable Long id) {
        ...
        return fileUploadResource.getPrepsFileUpload(id);
    }
    ...
    public ResponseEntity<Void> deleteFileUpload(@PathVariable Long id) {
        ...
        return fileUploadResource.deletePrepsFileUpload(id);
    }
}
